...
<?php
    ...
    <form class="formulariorecuperar" style="background-color:transparent" method="POST" action="<?php echo FUNCIONES;?>/recuperar.php">
        ...
        <h1 style="color:white">CORREO ENVIADO</h1>
        
         <div class="contenedor">
             <div>
             <h3 style="color:white">Te hemos enviado un correo para restablecer tu contraseña</h3>
             
             </div>
             <p style="color:white"><a class="link" href="<?php echo VISTAS;?>/iniciar-sesion.php" style="color:white">Volver</a></p>
         </div>
    </form>
